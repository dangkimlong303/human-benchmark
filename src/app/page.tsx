    ...
    <main className="flex-1 flex flex-col items-center">
      ...
      <section className="w-full max-w-6xl mx-auto py-16 px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Aim Speed Test Card */}
          <Link href="/tests/aim-speed" className="group block">
            <div className="bg-white dark:bg-zinc-800 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700 overflow-hidden hover:shadow-md hover:border-[#2b87d1] dark:hover:border-[#2b87d1] transition-all duration-200 h-full flex flex-col">
              <div className="bg-[#2b87d1] h-32 flex items-center justify-center text-white group-hover:bg-[#2069a5] transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="p-6">
                <h2 className="text-xl font-bold mb-2 text-zinc-900 dark:text-zinc-50">Aim Trainer</h2>
                <p className="text-zinc-600 dark:text-zinc-400">
                  Test your mouse aim speed and accuracy.
                </p>
              </div>
            </div>
          </Link>
          ...
          <div className="bg-zinc-100 dark:bg-zinc-800/50 rounded-xl border border-dashed border-zinc-300 dark:border-zinc-700 overflow-hidden h-full flex flex-col items-center justify-center p-6 text-zinc-400 dark:text-zinc-500 min-h-[250px]">
